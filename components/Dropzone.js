...
const Dropzone = () => {
    ...
    const onDropRejected = () => {
        mostrarAlerta('No se pudo subir, archivo muy grande, registrate para subir archivos más grandes')
    }

  //useCallback nos da una ganancia en performance al subir los archivos
